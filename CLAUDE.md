...
lane, judged by the act, never by the file. A fix under ten lines with no test change is the
exception, named in the report. Each worker is one role: builder, reviewer, or Explore,
