...
fixtures build.<!-- rule:verification-trust-guard-after-red --> Verify long work against the repo, not your status line.<!-- rule:verification-verify-against-repo --> Never write
