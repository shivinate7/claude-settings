...
WHO MADE THIS CALL. The orchestrator did, not the owner. The owner did not name
this paragraph. The authority is one instruction, given in the session of
2026-09-21, verbatim:
...
That instruction is a session grant. It is not a rule in CLAUDE.md. It does not
survive the session. It is quoted here so a later reader can weigh it, rather
than take the orchestrator's word. The owner can revise this repeal at any
time. The original sentence is quoted above for that purpose.
